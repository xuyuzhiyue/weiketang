...
$(function () {
    $('#grid1').datagrid({
        ...
        striped: true,
        fit: true,
        url: "<%=__APP__%>/Good!getList?btype=1",
        idField: 'id',
        pagination: true,
        rownumbers: true,
        pageSize: 10,
        ...
        columns: [
            [
                ...
                {title: '课程名称', width: 100, field: 'gname', sortable: true},
    ...
    $('#grid2').datagrid({
        ...
        columns: [
            [
                ...
                {title: '时间段', width: 100, field: 'title', sortable: true},
                {title: '上课地点', width: 100, field: 'rtitle', sortable: true}
            ]
        ], toolbar: [
            {
                text: '新增',
...
function save2() {
	$("#rtitle").val($("#rid").combobox("getText"));
	$("#pid").val(focusobj.id);
	$("#mtitle").val(focusobj.gname);
    $('#managForm2').form('submit', {
        url: "<%=__APP__%>/Changci!add",
        onSubmit: function () {
            return inputCheck2();
        },
        success: function (data) {
...
function deleteItem2(uuid) {
    openBackGround();
    $.post("<%=__APP__%>/Changci!deleteItem", {id: uuid}, function (data) {
        closeBackGround();
        $("#managerDialog2").dialog("close");
        $("#grid2").datagrid("reload");
    });
...
function mgChewei(obj){
	...
	$("#grid2").datagrid("options").url="<%=__APP__%>/Changci!getList?pid="+obj.id;
	$("#grid2").datagrid("reload");

	$("#rid").combobox({
        method:"get",
        url:'<%=__APP__%>/Room!roomList?sid='+obj.sid,
        valueField: 'id',
        textField: 'title'
    });
}
...
<div id="managerDialog" class="easyui-dialog" title="课程管理" style="width:650px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="btype" name="good.btype" value="1"/>
        <input type="hidden" id="oldimg" name="good.img"/>
        <input type="hidden" id="id" name="id"/>
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                <th width="30%" align="right"><label>课程名称：</label></th>
                <td width="30%">
                ...
                <td width="30%">
                    <select id="typeid" name="good.typeid">
			...
			<tr>
                <th width="30%" align="right"><label>所属类别：</label></th>
                <td width="30%">
                 ...
                 <th width="30%" align="right"><label>评分：</label></th>
                <td width="30%">
                    <input id="score" name="good.score" style="width:200px;word-wrap: break-word;word-break:break-all;" />
                </td>
            </tr>

            <tr>
                <th width="30%" align="right"><label>宣传海报：</label></th>
                <td colspan="" width="30%">
            ...
            <tr>
                <th width="30%" align="right"><label>试看片段：</label></th>
                <td colspan="3" width="30%">
                    <input type="file" name="video" id="video" style="width:200px;word-wrap: break-word;word-break:break-all;"/>
                </td>
...
<div id="listDialog" class="easyui-dialog" title="时间列表" style="width:650px;height:350px;" toolbar="#dlg-toolbar" resizable="true" modal="true" closed='true'>
...
<div id="managerDialog2" class="easyui-dialog" title="课程时间管理" style="width:450px;height:250px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm2" name="managForm2" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="pid" name="changci.pid"/>
        <input type="hidden" id="ptitle" name="changci.ptitle"/>
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                <th width="30%" align="right"><label>时间段：</label></th>
                <td width="30%" colspan="3">
                    <input id="title" name="changci.title" class="easyui-validatebox"
                           style="width:200px;word-wrap: break-word;word-break:break-all;" type="text" required="true"
                           validType="length[0,100]"/>
                </td>
            </tr>
            <tr>
                <th width="30%" align="right"><label>选择上课地点：</label></th>
                <td width="30%" colspan="3">
                    <input id="rid" name="changci.rid" style="width:200px;word-wrap: break-word;word-break:break-all;" />
                    <input id="rtitle" name="changci.rtitle" type="hidden"/>
                </td>
            </tr>
        </table>
    </form>
