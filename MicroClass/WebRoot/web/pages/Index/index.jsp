...
<head id="Head1">
    ...
    if(roletype == "1"){
    	_menus = {
   	         "menus": [
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "课程信息管理",
   	                 "menus": [
						 {"menuid": "11", "menuname": "课程列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!movie"},
   	                     /*{"menuid": "12", "menuname": "商品管理列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!good"}*/
   	                 ]},
   	                 
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "课程难度管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "课程难度列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!type"}
   	                 ]},
   	                 
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "授课地点管理",
   	                  "menus": [
   	                     {"menuid": "12", "menuname": "授课地点列表", "icon": "icon-database", "url": "<%= __APP__%>/Shop!shop"}
   	                 ]},
   	                 
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "最新资讯",
   	   	               "menus": [
   	   	                 {"menuid": "12", "menuname": "资讯列表", "icon": "icon-database", "url": "<%= __APP__%>/Notice!notice"}
   	   	             ]},
